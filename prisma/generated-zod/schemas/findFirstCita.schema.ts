...
export const CitaFindFirstSelectSchema: z.ZodType<Prisma.CitaSelect> = z.object({
...
export const CitaFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    id_paciente: z.boolean().optional(),
    estado: z.boolean().optional(),
    pagoinicial: z.boolean().optional(),
...
export const CitaFindFirstSchema: z.ZodType<Prisma.CitaFindFirstArgs> = z.object({ select: CitaFindFirstSelectSchema.optional(), include: z.lazy(() => CitaIncludeObjectSchema.optional()), orderBy: z.union([CitaOrderByWithRelationInputObjectSchema, CitaOrderByWithRelationInputObjectSchema.array()]).optional(), where: CitaWhereInputObjectSchema.optional(), cursor: CitaWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CitaScalarFieldEnumSchema, CitaScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CitaFindFirstArgs>;

export const CitaFindFirstZodSchema = z.object({ select: CitaFindFirstSelectSchema.optional(), include: z.lazy(() => CitaIncludeObjectSchema.optional()), orderBy: z.union([CitaOrderByWithRelationInputObjectSchema, CitaOrderByWithRelationInputObjectSchema.array()]).optional(), where: CitaWhereInputObjectSchema.optional(), cursor: CitaWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CitaScalarFieldEnumSchema, CitaScalarFieldEnumSchema.array()]).optional() }).strict();