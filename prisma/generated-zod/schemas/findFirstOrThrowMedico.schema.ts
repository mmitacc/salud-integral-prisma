...
export const MedicoFindFirstOrThrowSelectSchema: z.ZodType<Prisma.MedicoSelect> = z.object({
...
export const MedicoFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    id_especialidad: z.boolean().optional(),
    nombres: z.boolean().optional(),
    apellidos: z.boolean().optional(),
...
export const MedicoFindFirstOrThrowSchema: z.ZodType<Prisma.MedicoFindFirstOrThrowArgs> = z.object({ select: MedicoFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => MedicoIncludeObjectSchema.optional()), orderBy: z.union([MedicoOrderByWithRelationInputObjectSchema, MedicoOrderByWithRelationInputObjectSchema.array()]).optional(), where: MedicoWhereInputObjectSchema.optional(), cursor: MedicoWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MedicoScalarFieldEnumSchema, MedicoScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.MedicoFindFirstOrThrowArgs>;

export const MedicoFindFirstOrThrowZodSchema = z.object({ select: MedicoFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => MedicoIncludeObjectSchema.optional()), orderBy: z.union([MedicoOrderByWithRelationInputObjectSchema, MedicoOrderByWithRelationInputObjectSchema.array()]).optional(), where: MedicoWhereInputObjectSchema.optional(), cursor: MedicoWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MedicoScalarFieldEnumSchema, MedicoScalarFieldEnumSchema.array()]).optional() }).strict();