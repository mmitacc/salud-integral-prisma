...
const medicoscalarwherewithaggregatesinputSchema = z.object({
  ...
  idEspecialidad: z.union([z.lazy(() => IntWithAggregatesFilterObjectSchema), z.number().int()]).optional(),
  ...
  fechaNac: z.union([z.lazy(() => DateTimeWithAggregatesFilterObjectSchema), z.coerce.date()]).optional(),
