...
export const HistorialFindManySchema: z.ZodType<Prisma.HistorialFindManyArgs> = z.object({ select: HistorialFindManySelectSchema.optional(), include: z.lazy(() => HistorialIncludeObjectSchema.optional()), orderBy: z.union([HistorialOrderByWithRelationInputObjectSchema, HistorialOrderByWithRelationInputObjectSchema.array()]).optional(), where: HistorialWhereInputObjectSchema.optional(), cursor: HistorialWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([HistorialScalarFieldEnumSchema, HistorialScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.HistorialFindManyArgs>;

export const HistorialFindManyZodSchema = z.object({ select: HistorialFindManySelectSchema.optional(), include: z.lazy(() => HistorialIncludeObjectSchema.optional()), orderBy: z.union([HistorialOrderByWithRelationInputObjectSchema, HistorialOrderByWithRelationInputObjectSchema.array()]).optional(), where: HistorialWhereInputObjectSchema.optional(), cursor: HistorialWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([HistorialScalarFieldEnumSchema, HistorialScalarFieldEnumSchema.array()]).optional() }).strict();