...
export const PacienteFindFirstOrThrowSelectSchema: z.ZodType<Prisma.PacienteSelect> = z.object({
...
export const PacienteFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    nombres: z.boolean().optional(),
    apellidos: z.boolean().optional(),
    telefono: z.boolean().optional(),
...
export const PacienteFindFirstOrThrowSchema: z.ZodType<Prisma.PacienteFindFirstOrThrowArgs> = z.object({ select: PacienteFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => PacienteIncludeObjectSchema.optional()), orderBy: z.union([PacienteOrderByWithRelationInputObjectSchema, PacienteOrderByWithRelationInputObjectSchema.array()]).optional(), where: PacienteWhereInputObjectSchema.optional(), cursor: PacienteWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PacienteScalarFieldEnumSchema, PacienteScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PacienteFindFirstOrThrowArgs>;

export const PacienteFindFirstOrThrowZodSchema = z.object({ select: PacienteFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => PacienteIncludeObjectSchema.optional()), orderBy: z.union([PacienteOrderByWithRelationInputObjectSchema, PacienteOrderByWithRelationInputObjectSchema.array()]).optional(), where: PacienteWhereInputObjectSchema.optional(), cursor: PacienteWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PacienteScalarFieldEnumSchema, PacienteScalarFieldEnumSchema.array()]).optional() }).strict();